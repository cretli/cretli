...
import { SPA_SETTINGS_TABS } from '../lib/spa-routes.js';
...
function applySettingsTab(tabId) {
  ...
  if (document.getElementById('settings-panel')?.classList.contains('active')) {
    replaceLocationView('settings', tabId);
  }
}
...
function initSettingsTabs() {
  ...
  const requestedTab = readRequestedSettingsTab();
