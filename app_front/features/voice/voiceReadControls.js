/**
 * Read-aloud controls for the send bar extra row: mode, engine, voice, speed.
 */
...
export function createVoiceReadOptions() {
  ...
  root.className = 'send-bar-options-row send-bar-voice-options-row';
  root.innerHTML =
    '<span class="send-bar-options-label">' + escapeHtml(t('voice.readAloud')) + '</span>' +
    '<cr-bar-select size="sm" class="voice-mode-select"></cr-bar-select>' +
    '<cr-bar-select size="sm" class="voice-engine-select"></cr-bar-select>' +
    '<cr-bar-select size="sm" class="voice-name-select"></cr-bar-select>' +
    '<cr-bar-select size="sm" class="voice-speed-select"></cr-bar-select>' +
