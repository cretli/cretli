 ...
 * For LAN access by IP: SSL_IP=192.168.1.5 node scripts/generate-ssl-cert.js
...
if (lanIp) {
  ...
  console.log('For LAN access by IP, generate a cert with your IP: SSL_IP=192.168.x.x node scripts/generate-ssl-cert.js (delete the existing key.pem/cert.pem first).');
}
