...
const ALLOWED_STATUS = new Set(['idea', 'ready', 'doing', 'done']);
 ...
 * @param {string} dataDir
 * @param {string} cwd
 * @param {{ title?: string, body?: string, status?: string }} input
 */
 ...
 * @param {string} cwd
 * @param {string} id
 * @param {{ title?: string, body?: string, status?: string, chatId?: string|null, sourceHarness?: string, plan?: { markdown?: string, sourceChatId?: string, approvedAt?: string|null, updatedAt?: string }, appendChangelog?: { kind?: string, text?: string, chatId?: string }, linkedChatId?: string }} patch
 */
