...
/** @type {Readonly<Record<'sdk' | 'openrouter' | 'opencode', HarnessPlanPolicy>>} */
...
/** Built-in Cursor SDK tools withheld in Plan mode. Do not include mcp (drops custom tools). */
export const SDK_PLAN_DISALLOWED_TOOLS = Object.freeze(['edit', 'write', 'delete', 'shell']);
